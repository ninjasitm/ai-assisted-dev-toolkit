---
applyTo: "**/*"
description: "Server/client boundary enforcement and data fetching patterns for the {{PROJECT_NAME}} monorepo."
---
...
- Use shared packages from `{{PACKAGES_DIR}}/` for cross-boundary types and utilities.
