...
Coordinate test-driven development with red-green-refactor cycle using specialized subagents.

**CRITICAL: READ:** [.claude/agents-snippets/tdd.md](../agents-snippets/tdd.md)
