...
2. **Ask for the commit range** (date range, tag range, or number of commits)

3. **Gather commit data** using terminal commands:
...
5. **Generate release notes** in the selected format:
...
6. **Present the release notes** and ask if adjustments are needed
